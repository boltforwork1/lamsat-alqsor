    ...
    <div className="bg-black pt-32">
      <header className="section-padding text-center space-y-4">
        ...
        >
          ...
          <h1 className="text-3xl md:text-5xl lg:text-7xl gold-text mt-4">Our Services</h1>
          ...
          >
            <div className="lg:w-1/2 space-y-6 md:space-y-10">
              <div className="space-y-4">
                <h2 className="text-2xl md:text-3xl lg:text-4xl gold-text">{service.title}</h2>
                <p className="text-primary text-xs md:text-sm tracking-[0.2em] uppercase font-serif">{service.subtitle}</p>
      ...
      <section className="bg-zinc-950 py-16 md:py-32 overflow-hidden border-t border-white/5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-8 md:space-y-12">
          <h2 className="text-3xl md:text-4xl gold-text">Artistic Vision</h2>
